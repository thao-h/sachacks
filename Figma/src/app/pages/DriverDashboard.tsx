...
const MOCK_ACTIVE_DELIVERIES: ActiveDelivery[] = [
  {
    id: 'DEL-101',
...
export function DriverDashboard() {
  ...
  const [activeDeliveries, setActiveDeliveries] = useState(MOCK_ACTIVE_DELIVERIES);
          ...
          {!activeRoute ? (
            <div className="p-4 space-y-4">
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  <label className="text-xs font-medium text-gray-500 mb-1.5 block">Leaving at</label>
                  <div className="relative">
                ...
                <div>
                  <label className="text-xs font-medium text-gray-500 mb-1.5 block">Capacity</label>
                  <div className="flex items-center justify-between bg-gray-50 border border-gray-200 rounded-lg px-2 py-1.5">
                    ...
                    <span className="text-sm font-medium text-gray-900">{capacity} orders</span>
                    <button 
            ...
            <div className="p-4">
              <div className="flex items-start justify-between mb-4">
                <div>
                  <div className="text-sm text-gray-500 mb-1">Active Route</div>
                  <div className="font-semibold text-gray-900">UC Davis Campus → West Davis</div>
                  <div className="text-sm text-blue-600 mt-1">Leaving at 5:30 PM • {capacity} spots left</div>
                </div>
                <button 
                ...
                <div className="p-4">
                  <div className="flex justify-between items-start mb-3">
                    <div className="space-y-1">
                      <h3 className="font-bold text-gray-900 text-lg">{offer.restaurantName}</h3>
                    ...
                    <div className="text-right">
                      <div className="text-xl font-bold text-green-600">${offer.earnings.toFixed(2)}</div>
                  ...
                  <div className="flex items-center justify-between pt-3 border-t border-gray-100">
                    <div className="text-xs text-gray-500">
                      Ready at <span className="font-medium text-gray-900">{offer.readyTime}</span>
                    </div>
                  ...
                  <button className="w-full mt-3 bg-green-600 hover:bg-green-700 text-white font-semibold py-2.5 rounded-lg transition-colors shadow-sm active:scale-[0.98]">
                    Accept Delivery
                  </button>
                </div>
              </motion.div>
        ...
        <section>
          ...
          <div className="space-y-3">
            {activeDeliveries.map((delivery) => (
              <div key={delivery.id} className="bg-white rounded-xl shadow-sm border border-gray-200 p-4">
                <div className="flex justify-between items-start mb-3">
                  <div>
                    <div className="flex items-center gap-2 mb-1">
                      ...
                      <span className="text-sm text-gray-500">• {delivery.restaurantName}</span>
                    </div>
                    <h3 className="font-semibold text-gray-900">{delivery.deliveryAddress}</h3>
                ...
                <div className="grid grid-cols-2 gap-3 mt-4">
                  <button className="flex items-center justify-center gap-2 bg-blue-50 hover:bg-blue-100 text-blue-700 font-medium py-2 rounded-lg transition-colors text-sm border border-blue-200">
                    <CheckCircle className="w-4 h-4" />
                    Picked Up
                  </button>
                  <button className="flex items-center justify-center gap-2 bg-green-50 hover:bg-green-100 text-green-700 font-medium py-2 rounded-lg transition-colors text-sm border border-green-200">
      ...
      <div className="fixed bottom-0 left-0 right-0 bg-white border-t border-gray-200 p-4 safe-area-bottom">
        <div className="max-w-lg mx-auto flex items-center justify-between">
          <div>
            ...
            <div className="text-xl font-bold text-gray-900">$24.50</div>
          </div>
          <div className="text-right">
            <div className="text-xs text-gray-500">Completed</div>
            <div className="text-base font-semibold text-gray-900">4 Deliveries</div>
          </div>
        </div>
      </div>
    </div>

      ...
      <div className="bg-white rounded-t-3xl shadow-[0_-4px_20px_rgba(0,0,0,0.1)] relative z-10 -mt-6 flex flex-col max-h-[60vh]">
        ...
        <div className="px-6 py-4 overflow-y-auto">
            ...
            {statusSteps.map((step, index) => {
              ...
              return (
                ...
                >
                  ...
                  <span
                    className={`text-[10px] font-medium ${isCurrent ? "text-blue-600" : "text-gray-500"}`}
                  >
                    {step.label}
                  </span>
                </div>
          ...
          <div className="grid grid-cols-2 gap-3 mb-6">
            <Link
              href="/customer"
              className="flex items-center justify-center py-3 bg-gray-100 hover:bg-gray-200 text-gray-700 font-medium rounded-xl text-sm transition-colors"
            >
              Menu
            </Link>
            <Link
              href="/"
              className="flex items-center justify-center py-3 bg-blue-600 hover:bg-blue-700 text-white font-medium rounded-xl text-sm transition-colors"
            >
              Home
            </Link>
          </div>

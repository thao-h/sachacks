...
> = {
  order: { label: "Ordering", color: "bg-blue-100 text-blue-700", icon: ShoppingBag },
  ...
  return (
    <div ref={ref} className="relative">
      <button
        ...
        className="flex items-center gap-2 p-1.5 hover:bg-gray-100 rounded-lg transition-colors border border-transparent hover:border-gray-200"
      >
        {/* Mode chip */}
        <div
      ...
      {open && (
        <div className="absolute right-0 top-full mt-2 w-64 bg-white rounded-xl shadow-xl border border-gray-200 py-2 z-[60]">
          {/* User info */}

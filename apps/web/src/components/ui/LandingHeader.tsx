...
export function LandingHeader({
  ...
  return (
    <header className="backdrop-blur-xl bg-white/80 border-b border-stone-200/60 sticky top-0 z-50">
          ...
          <div className="flex items-center gap-3">
            {user ? (
              ...
              <button
                ...
                className="flex items-center gap-2 px-4 py-2 bg-primary-600 hover:bg-primary-700 text-white rounded-lg text-sm font-semibold transition-all duration-150 active:scale-[0.98] shadow-sm shadow-primary-600/20"
              >
      ...
      <AnimatePresence>
        {isMobileMenuOpen && (
          <motion.div
            ...
            className="md:hidden border-t border-stone-100 bg-white/95 backdrop-blur-xl absolute w-full left-0 shadow-lg z-50 overflow-hidden"
          >
            <div className="p-2 space-y-1">
              ...
              {user && (
                <div className="mt-2 pt-2 border-t border-stone-100 px-4 py-2">
